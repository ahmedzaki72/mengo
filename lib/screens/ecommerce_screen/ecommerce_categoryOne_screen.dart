...
class ECommerceCategoryOneScreen extends StatefulWidget {
  static const String routeName = "ecommerce_category_one_screen";

  @override
  _ECommerceCategoryOneScreenState createState() =>
      _ECommerceCategoryOneScreenState();
}

class _ECommerceCategoryOneScreenState
    extends State<ECommerceCategoryOneScreen> {
  File image;
  String name;
  String price;
                    ...
                    children: [
                      ...
                      BlocConsumer<ECommerceCubit, ECommerceStates>(
                        listener: (context, states) {
                          if (states is ECommerceCategoryOneSuccessStates) {
                            if (states.eCommerceCategoryOne.commercialResponse
                                    .status ==
                                '200') {
                              Navigator.pushNamed(context,
                                  ECommerceCategoryTwoScreen.routeName);
                            }
                          }
                        },
                        builder: (context, states) {
                          var cubit = ECommerceCubit.get(context);
                          if(states is! ECommerceCategoryOneLoadingStates) {
